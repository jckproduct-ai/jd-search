...
🔴 **첫 실행은 상한 없이 전부 받습니다.** 사람인 기준 20~35분 걸립니다 — 시작 전에 몇 건을 받는지, 몇 분 걸리는지 알려 드립니다.
처음 만들어진 목록이 5분의 1이면 그 5분의 1을 자기 시장 전부로 읽게 되고, 경고 한 줄로는 그 오해를 못 막습니다.
두 번째 실행부터는 기본 200건이며, 이 상한은 **새로 받아야 하는 공고만** 셉니다 — 이미 받아 둔 것까지 세면 목록 뒤쪽의 새 공고가 영영 안 받아집니다.
